	...
	<style type="text/css">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                <%
                if((int)session.getAttribute("ExpertBlocked") == 1){
                    %>
                    ...
                    <%
                }else if((int)session.getAttribute("ExpertLoginFailed") == 1){
                    %>
                    ...
                    <%
                }else if((int)session.getAttribute("ExpertTemporaryPasswordSentOnMail") == 1){
                    %>
                    ...
                    <%
                }else if((int)session.getAttribute("ExpertPasswordChangedSuccessfully") == 1){
                    %>
